...
public class Girokonto extends Konto {
	 ...
	 *             wenn der inhaber null ist oder der angegebene dispo negativ ist
	 */
	...
	/**
	 * Wechselt die aktuelle waehrung auf dem Konto zu der gewuenschten neuen
	 */
	
	public void waehrungswechsel(Waehrung neu) {
		if (getAktuelleWaehrung() == Waehrung.EUR && neu != Waehrung.EUR) {
			System.out.println(neu);
			setKontostand(neu.euroInWaehrungUmrechnen(getKontostand()));
			this.waehrung = neu;
		} else if (getAktuelleWaehrung() != Waehrung.EUR && neu == Waehrung.EUR) {
			System.out.println(neu);
	...
	/**
	 * vermindert den Kontostand um den angegebenen Betrag, falls das Konto nicht
	 * gesperrt ist. Am Empf�ngerkonto wird keine �nderung vorgenommen, da davon
	 * ausgegangen wird, dass dieses sich bei einer anderen Bank befindet.
	 * 
	 * @param betrag
	 *            double
	 * @param empfaenger
	 ...
	 * @throws IllegalArgumentException
	 *             wenn der Betrag negativ ist oder empfaenger oder verwendungszweck
	 *             null ist
	 */
	 ...
	 *            int
	 * @param verwendungszweck
	 *            String * @throws IllegalArgumentException wenn der Betrag negativ
	 *            ist oder vonName oder verwendungszweck null ist
	 */
	...
	public String toString() {
		String ausgabe = "-- GIROKONTO --" + System.lineSeparator() + super.toString() + "Dispo: " + this.dispo
